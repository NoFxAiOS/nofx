...
- **中文**: Читайте [DOCKER_DEPLOY.md](DOCKER_DEPLOY.md)
...
| `binance_api_key_type` | Тип подписи Binance API | `"Hmac"` или `"Ed25519"` | Опционально, по умолчанию `"Hmac"` |
...
- **Проблема**: Ранее P/L рассчитывалось только как процент, полностью игнорируя размер позиции и плечо
