...
func supportedModelProviders() []modelProviderSpec {
	return []modelProviderSpec{
		...
		{ID: "claude", DisplayName: "Claude", DefaultModel: "claude-opus-4-8", CredentialLabelZH: "API Key", CredentialLabelEN: "API key", SupportsCustomAPIURL: true, SupportsCustomModel: true},
