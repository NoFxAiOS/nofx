...
func (e *StrategyEngine) BuildSystemPrompt(accountEquity float64, variant string) string {
	...
	sb.WriteString("  - **Position sizing rules**: When `drawdown_rules` are present, ladder TP ratios do NOT need to sum to 80%+ (drawdown handles runners). Without drawdown, TP ratios should total 60~90%. SL ratios may total up to 100%.\n")
