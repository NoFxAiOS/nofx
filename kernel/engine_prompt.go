...
func (e *StrategyEngine) BuildSystemPrompt(accountEquity float64, variant string) string {
	...
	sb.WriteString("  - If the strategy config disables a protection dimension, do not invent it in protection_plan\n")
	sb.WriteString("  - If the strategy config keeps some dimensions manual/disabled, output only the AI-controlled parts and let code/manual config fill the rest\n")
