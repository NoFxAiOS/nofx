...
// ExitConfig position exit configuration (stop loss / take profit percentages)
type ExitConfig struct {
	// 固定止损百分比，例如 2.0 表示 2%
	StopLossPct float64 `json:"stop_loss_pct,omitempty"`
	// 第一阶段止盈百分比，例如 2.0 表示 2%
	TakeProfit1Pct float64 `json:"take_profit_1_pct,omitempty"`
	// 第二阶段止盈百分比，例如 6.0 表示 6%
	TakeProfit2Pct float64 `json:"take_profit_2_pct,omitempty"`
}
...
type StrategyConfig struct {
	...
	// exit configuration (stop loss / take profit)
