        ...
        {decision.system_prompt && (
          <div>
            <button
              ...
              className="flex flex-row items-center gap-2 text-sm transition-colors w-full justify-between p-2 sm:p-2 rounded hover:bg-white/5"
            >
              <div className="flex items-center gap-2 flex-shrink-0 min-w-0">
                <span className="text-base flex-shrink-0">⚙️</span>
                <span className="font-semibold truncate min-w-0" style={{ color: '#a78bfa' }}>
                  System Prompt
                </span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap sm:flex-nowrap flex-shrink-0 justify-start sm:justify-start">
                <button
                  ...
                  className="text-xs px-2 sm:px-2.5 py-1 rounded hover:opacity-80 transition-opacity flex items-center justify-center gap-1 flex-shrink-0"
            ...
            {showSystemPrompt && (
              <div
                className="mt-2 rounded-lg p-3 sm:p-4 text-xs sm:text-sm font-mono whitespace-pre-wrap max-h-96 overflow-y-auto"
                style={{
                  background: '#0B0E11',
                  border: '1px solid #2B3139',
                  color: '#EAECEF',
          ...
          <div>
            ...
            >
              <div className="flex items-center gap-2 flex-shrink-0 min-w-0">
                ...
                <span className="font-semibold truncate min-w-0" style={{ color: '#60a5fa' }}>
                  User Prompt
                </span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap sm:flex-nowrap flex-shrink-0 justify-start sm:justify-start">
