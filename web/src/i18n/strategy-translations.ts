...
export const coinSource = {
  ...
  market_screener: { zh: '市场筛选', en: 'Market Screener', es: 'Filtro de Mercado' },
  ...
  ai500Desc: { zh: '交易所原生数据筛选（成交额+OI+活跃度）', en: 'Exchange-native screening (volume+OI+activity)', es: 'Filtrado nativo del exchange' },
  oi_topDesc: { zh: '交易所 OI 持仓增加榜，适合做多', en: 'Exchange OI increase ranking, for long', es: 'Ranking OI creciente, para largo' },
  oi_lowDesc: { zh: '交易所 OI 持仓减少榜，适合做空', en: 'Exchange OI decrease ranking, for short', es: 'Ranking OI decreciente, para corto' },
  ...
  market_screenerDesc: { zh: '从市场数据页筛选热门币种（成交额+OI+活跃度）', en: 'Screen hot coins from market data (volume+OI+activity)', es: 'Filtrar monedas del mercado (volumen+OI+actividad)' },
