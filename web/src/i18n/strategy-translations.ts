...
export const coinSource = {
  ...
  gmgn_trending: { zh: 'GMGN 热榜', en: 'GMGN Trending', es: 'GMGN Trending' },
  ...
  gmgnTrendingChain: { zh: '链', en: 'Chain', es: 'Cadena' },
  gmgnTrendingInterval: { zh: '周期', en: 'Window', es: 'Ventana' },
  gmgnTrendingLimit: { zh: '数量上限', en: 'Limit', es: 'Límite' },
  ...
  gmgn_trendingDesc: { zh: '从 GMGN Trending 动态拉取热门链上代币', en: 'Dynamically fetch hot on-chain tokens from GMGN Trending', es: 'Obtener tokens dinámicos desde GMGN Trending' },
  mixedDesc: { zh: '组合多种数据源', en: 'Combine multiple sources', es: 'Combinar fuentes múltiples' },
  gmgnTrendingTitle: { zh: 'GMGN 热榜', en: 'GMGN Trending', es: 'GMGN Trending' },
  gmgnTrendingNote: { zh: '运行时使用 Trader 绑定的 GMGN API Key；在 Strategy Studio 单独测试时可回退读取环境变量 GMGN_API_KEY。', en: 'Uses the trader-linked GMGN API key at runtime; Strategy Studio-only testing falls back to GMGN_API_KEY from the environment.', es: 'Usa la GMGN API key del trader en runtime; en Strategy Studio usa GMGN_API_KEY del entorno como fallback.' },
