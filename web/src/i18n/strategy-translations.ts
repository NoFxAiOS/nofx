...
export const indicator = {
  ...
  adanosSentiment: { zh: 'Adanos 市场情绪', en: 'Adanos Market Sentiment', es: 'Sentimiento Adanos' },
  adanosSentimentDesc: { zh: '可选 - 将社交、新闻或预测市场情绪加入 AI 上下文', en: 'Optional - enriches AI context with social, news or prediction-market sentiment', es: 'Opcional - agrega sentimiento social, noticias o mercados predictivos' },
  adanosApiKeyPlaceholder: { zh: '输入 Adanos API Key（可选）', en: 'Enter Adanos API Key (optional)', es: 'Ingresar Adanos API Key (opcional)' },
  adanosApiKeyEnvFallback: { zh: '留空时后端会尝试使用 ADANOS_API_KEY 环境变量。', en: 'Leave blank to let the backend use the ADANOS_API_KEY environment variable.', es: 'Dejar vacio para usar la variable de entorno ADANOS_API_KEY.' },
  adanosSource: { zh: '来源', en: 'Source', es: 'Fuente' },
  adanosDays: { zh: '天数', en: 'Days', es: 'Dias' },
  adanosMaxSymbols: { zh: '最大币种数', en: 'Max Symbols', es: 'Max Simbolos' },
  adanosDocs: { zh: '文档', en: 'Docs', es: 'Docs' },
