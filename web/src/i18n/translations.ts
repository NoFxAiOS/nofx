...
export const translations = {
  en: {
    ...
    strategyStudio: {
      ...
      templates: 'Templates',
      gmgnSolLiveName: 'GMGN SOL Live',
      gmgnSolLiveShort: 'Spot-only SOL starter',
      gmgnSolLiveDescription: 'GMGN SOL mainnet live trading starter. Spot-only, long-only, USDC-settled, and intended for a static SOL token list. Fill in the token list before enabling live trading.',
      gmgnSolLiveTooltip: 'Create a built-in GMGN SOL spot template',
  ...
  zh: {
    ...
    strategyStudio: {
      ...
      importStrategy: '导入策略',
      templates: '模板',
      gmgnSolLiveName: 'GMGN SOL 实盘',
      gmgnSolLiveShort: 'SOL 现货实盘模板',
      gmgnSolLiveDescription: 'GMGN SOL 主网实盘起手模板。spot-only、long-only、USDC 结算，适用于静态 SOL 币池。启用实盘前请先补全 static_coins。',
      gmgnSolLiveTooltip: '创建内置的 GMGN SOL 现货模板',
  ...
  id: {
    ...
    strategyStudio: {
      ...
      templates: 'Template',
      gmgnSolLiveName: 'GMGN SOL Live',
      gmgnSolLiveShort: 'Template spot-only SOL',
      gmgnSolLiveDescription: 'Template awal untuk live trading GMGN SOL mainnet. Spot-only, long-only, settled in USDC, dan ditujukan untuk daftar token SOL statis. Isi static_coins sebelum dipakai live.',
      gmgnSolLiveTooltip: 'Buat template spot GMGN SOL bawaan',
