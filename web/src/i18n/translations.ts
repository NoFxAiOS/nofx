...
export const translations = {
  en: {
    ...
    faqSupportedExchangesAnswer:
      'CEX (Centralized): Binance Futures, Bybit, OKX, Bitget, Weex. DEX (Decentralized): Hyperliquid, Aster DEX, Lighter. Each exchange has different features - Binance has the most liquidity, Hyperliquid is fully on-chain with no KYC required. Check the documentation for setup guides for each exchange.',
  ...
  zh: {
    ...
    faqSupportedExchangesAnswer:
      'CEX（中心化）：币安合约、Bybit、OKX、Bitget、Weex。DEX（去中心化）：Hyperliquid、Aster DEX、Lighter。每个交易所有不同特点 - 币安流动性最好，Hyperliquid 完全链上无需 KYC。查看文档获取各交易所的设置指南。',
