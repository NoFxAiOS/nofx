...
export const translations = {
  en: {
    ...
    signer: 'API Wallet Address (Signer)',
    passphrase: 'Passphrase',
    enterPrivateKey: 'Enter Private Key',
    enterWalletAddress: 'Enter Wallet Address',
    enterUser: 'Enter Main Wallet Address (0x...)',
    enterSigner: 'Enter API Wallet Address (0x...)',
    ...
    asterUserDesc: 'Your main wallet address used to login Aster DEX',
    asterSignerDesc: 'API wallet address from Aster API settings',
    asterPrivateKeyDesc: 'API wallet private key from Aster API settings',
  ...
  zh: {
    ...
    enterUser: '输入主钱包地址（0x开头）',
    enterSigner: '输入API钱包地址（0x开头）',
    enterPassphrase: '输入Passphrase (OKX必填)',
    hyperliquidPrivateKeyDesc: 'Hyperliquid 使用私钥进行交易认证',
    hyperliquidWalletAddressDesc: '与私钥对应的钱包地址',
    asterUserDesc: '您在 Aster DEX 登录时使用的主钱包地址',
    asterSignerDesc: '从 Aster API 设置页面获取的 API 钱包地址',
    asterPrivateKeyDesc: '从 Aster API 设置页面获取的 API 钱包私钥',
